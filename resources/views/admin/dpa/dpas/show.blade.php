        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left font-semibold text-gray-700">Kode RUP</th>
                    ...
                    <th class="px-4 py-3 text-left font-semibold text-gray-700">Penyedia</th>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($dpa->paketPekerjaans as $paket)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-gray-600">{{ $paket->kode_rup ?: '—' }}</td>
                        ...
                        <td class="px-4 py-3 text-gray-600">{{ $paket->penyedia?->nama ?: '—' }}</td>
